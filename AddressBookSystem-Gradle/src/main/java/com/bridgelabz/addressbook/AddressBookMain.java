...
/**
 * it contains methods like to add contacts to addressBook(),to search the name in address book
 * map is also used to store the data in key and value pair
 */
public class AddressBookMain {
    ...
    /**
     * Serach the contacts either by city or name of the person i.e first name
     * @param city
     * @param name
     */
